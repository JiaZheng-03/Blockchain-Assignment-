export const ESCROW_ABI = [
  ...
  'function getMilestones(uint256 agreementId) view returns (tuple(string name,string details,uint256 payout,uint64 dueAt,bytes32 proofHash,string proofURI,uint64 submittedAt,uint64 approvedAt,uint8 state)[])',
...
export const MILESTONE_STATUS = ['Pending', 'Evidence submitted', 'Approved'];
